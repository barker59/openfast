...
#line 155 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
  call assertEqual(baseline_rrN0(:,:,1), p%rrN0(:,:,1), tolerance, testname, &
 & location=SourceLocation( &
 & 'test_BD_QuadraturePointData.F90', &
 & 155) )
  if (anyExceptions()) return
#line 156 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"

        ! Test uu0; only one quadrature point for now
        testname = "5 node, 1 element, 1 qp, curved: BD_DisplacementQPAt0: uu0"
        do idx_qp = 1, p%nqp
#line 160 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
  call assertEqual(baseline_uu0(:,idx_qp,1), p%uu0(:,idx_qp,1), tolerance, testname, &
 & location=SourceLocation( &
 & 'test_BD_QuadraturePointData.F90', &
 & 160) )
  if (anyExceptions()) return
#line 161 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
        end do

        ! Test E10; only one quadrature point for now
        testname = "5 node, 1 element, 1 qp, curved: BD_DisplacementQPAt0: E10"
        do idx_qp = 1, p%nqp
#line 166 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
  call assertEqual(baseline_E10(:,idx_qp,1), p%E10(:,idx_qp,1), tolerance, testname, &
 & location=SourceLocation( &
 & 'test_BD_QuadraturePointData.F90', &
 & 166) )
  if (anyExceptions()) return
#line 167 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
        end do
...
#line 201 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
  call assertEqual(baseline_uuu(1:3,idx_qp,1), m%qp%uuu(1:3,idx_qp,1), tolerance, testname, &
 & location=SourceLocation( &
 & 'test_BD_QuadraturePointData.F90', &
 & 201) )
  if (anyExceptions()) return
#line 202 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
             testname = "5 node, 1 element, 1 qp, curved: BD_DisplacementQP: uup"
#line 203 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
  call assertEqual(baseline_uup(1:3,idx_qp,1), m%qp%uup(1:3,idx_qp,1), tolerance, testname, &
 & location=SourceLocation( &
 & 'test_BD_QuadraturePointData.F90', &
 & 203) )
  if (anyExceptions()) return
#line 204 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
             testname = "5 node, 1 element, 1 qp, curved: BD_DisplacementQP: E1"
#line 205 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
  call assertEqual(baseline_E1(1:3,idx_qp,1), m%qp%E1(1:3,idx_qp,1), tolerance, testname, &
 & location=SourceLocation( &
 & 'test_BD_QuadraturePointData.F90', &
 & 205) )
  if (anyExceptions()) return
#line 206 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
        end do
...
#line 225 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
  call assertEqual(baseline_Nrrr(1:3,idx_node,1), m%Nrrr(1:3,idx_node,1), tolerance, testname, &
 & location=SourceLocation( &
 & 'test_BD_QuadraturePointData.F90', &
 & 225) )
  if (anyExceptions()) return
#line 226 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
        end do 

        do idx_qp = 1, p%nqp
             testname = "5 node, 1 element, 1 qp, curved: BD_RotationalInterpQP: m%qp%uuu(4:6)"
#line 230 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
  call assertEqual(baseline_uuu(4:6,idx_qp,1), m%qp%uuu(4:6,idx_qp,1), tolerance, testname, &
 & location=SourceLocation( &
 & 'test_BD_QuadraturePointData.F90', &
 & 230) )
  if (anyExceptions()) return
#line 231 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
             testname = "5 node, 1 element, 1 qp, curved: BD_RotationalInterpQP: m%qp%kappa"
#line 232 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
  call assertEqual(baseline_kappa(1:3,idx_qp,1), m%qp%kappa(1:3,idx_qp,1), tolerance, testname, &
 & location=SourceLocation( &
 & 'test_BD_QuadraturePointData.F90', &
 & 232) )
  if (anyExceptions()) return
#line 233 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
             testname = "5 node, 1 element, 1 qp, curved: BD_RotationalInterpQP: m%qp%RR0"
#line 234 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
  call assertEqual(baseline_RR0(1:3,1:3,idx_qp,1), m%qp%RR0(1:3,1:3,idx_qp,1), tolerance, testname, &
 & location=SourceLocation( &
 & 'test_BD_QuadraturePointData.F90', &
 & 234) )
  if (anyExceptions()) return
#line 235 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
        end do
...
#line 256 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
  call assertEqual(baseline_Stif(1:6,1:6,idx_qp,1), m%qp%Stif(1:6,1:6,idx_qp,1), 10.*tolerance, testname, &
 & location=SourceLocation( &
 & 'test_BD_QuadraturePointData.F90', &
 & 256) )
  if (anyExceptions()) return
#line 257 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_QuadraturePointData.F90"
        end do
...
module Wraptest_BD_QuadraturePointData
   use pFUnit_mod
   use test_BD_QuadraturePointData
   implicit none
   private
...
end module Wraptest_BD_QuadraturePointData

function test_BD_QuadraturePointData_suite() result(suite)
   use pFUnit_mod
   use test_BD_QuadraturePointData
   use Wraptest_BD_QuadraturePointData
   type (TestSuite) :: suite

   suite = newTestSuite('test_BD_QuadraturePointData_suite')

   call suite%addTest(newTestMethod('test_BD_QuadraturePointData_5node', test_BD_QuadraturePointData_5node))


end function test_BD_QuadraturePointData_suite
