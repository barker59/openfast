...
#line 78 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_MemberEta.F90"
  call assertEqual(baseline_total_length,  test_total_length, tolerance, testname, &
 & location=SourceLocation( &
 & 'test_BD_MemberEta.F90', &
 & 78) )
  if (anyExceptions()) return
#line 79 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_MemberEta.F90"
#line 79 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_MemberEta.F90"
  call assertEqual(baseline_member_eta, test_member_eta, tolerance, testname, &
 & location=SourceLocation( &
 & 'test_BD_MemberEta.F90', &
 & 79) )
  if (anyExceptions()) return
#line 80 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_MemberEta.F90"
...
module Wraptest_BD_MemberEta
   use pFUnit_mod
   use test_BD_MemberEta
   implicit none
   private
...
end module Wraptest_BD_MemberEta

function test_BD_MemberEta_suite() result(suite)
   use pFUnit_mod
   use test_BD_MemberEta
   use Wraptest_BD_MemberEta
   type (TestSuite) :: suite

   suite = newTestSuite('test_BD_MemberEta_suite')

   call suite%addTest(newTestMethod('test_BD_MemberEta_5node', test_BD_MemberEta_5node))


end function test_BD_MemberEta_suite
