...
#line 92 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_diffmtc.F90"
  call assertEqual(baseline_shape, test_shape, tolerance, testname, &
 & location=SourceLocation( &
 & 'test_BD_diffmtc.F90', &
 & 92) )
  if (anyExceptions()) return
#line 93 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_diffmtc.F90"
#line 93 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_diffmtc.F90"
  call assertEqual(baseline_shapederivative, test_shapederivative, tolerance, testname, &
 & location=SourceLocation( &
 & 'test_BD_diffmtc.F90', &
 & 93) )
  if (anyExceptions()) return
#line 94 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_diffmtc.F90"
...
#line 151 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_diffmtc.F90"
  call assertEqual(baseline_shape, test_shape, tolerance, testname, &
 & location=SourceLocation( &
 & 'test_BD_diffmtc.F90', &
 & 151) )
  if (anyExceptions()) return
#line 152 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_diffmtc.F90"
#line 152 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_diffmtc.F90"
  call assertEqual(baseline_shapederivative, test_shapederivative, tolerance, testname, &
 & location=SourceLocation( &
 & 'test_BD_diffmtc.F90', &
 & 152) )
  if (anyExceptions()) return
#line 153 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_BD_diffmtc.F90"
...
end module Wraptest_BD_diffmtc

function test_BD_diffmtc_suite() result(suite)
   use pFUnit_mod
   use test_BD_diffmtc
   use Wraptest_BD_diffmtc
   type (TestSuite) :: suite

   suite = newTestSuite('test_BD_diffmtc_suite')

   call suite%addTest(newTestMethod('test_BD_diffmtc_2node', test_BD_diffmtc_2node))

   call suite%addTest(newTestMethod('test_BD_diffmtc_5node', test_BD_diffmtc_5node))


end function test_BD_diffmtc_suite
