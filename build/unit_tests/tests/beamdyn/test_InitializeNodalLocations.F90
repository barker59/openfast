...
#line 121 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_InitializeNodalLocations.F90"
  call assertEqual(baseline_uuN0, p%uuN0, tolerance, testname, &
 & location=SourceLocation( &
 & 'test_InitializeNodalLocations.F90', &
 & 121) )
  if (anyExceptions()) return
#line 122 "/Users/abarker/Desktop/Fast/openfast/unit_tests/../modules/beamdyn/tests/test_InitializeNodalLocations.F90"
...
module Wraptest_InitializeNodalLocations
   use pFUnit_mod
   use test_InitializeNodalLocations
   implicit none
   private
...
end module Wraptest_InitializeNodalLocations

function test_InitializeNodalLocations_suite() result(suite)
   use pFUnit_mod
   use test_InitializeNodalLocations
   use Wraptest_InitializeNodalLocations
   type (TestSuite) :: suite

   suite = newTestSuite('test_InitializeNodalLocations_suite')

   call suite%addTest(newTestMethod('test_InitializeNodalLocations_np5_p6', test_InitializeNodalLocations_np5_p6))


end function test_InitializeNodalLocations_suite
