...
end module Wrapifw_test_tools

function ifw_test_tools_suite() result(suite)
   use pFUnit_mod
   use ifw_test_tools
   use Wrapifw_test_tools
   type (TestSuite) :: suite

   suite = newTestSuite('ifw_test_tools_suite')


end function ifw_test_tools_suite
